...
insert into dbo.People(FirstName,LastName,PhoneNumber,Picture,Email) values('Phillip','Panzenbck','09923411',203432940,'p.panzi@gmail.com');
...
insert into dbo.Contacts(FK_Person) select id from dbo.People where LastName = 'Panzenbck';
...
insert into Companies(Name,Email,Homepage,PhoneNumber,ShortDescription,CompanySign,SubjectAreas,FK_Address,FK_Contact)
	...
	from Addresses a, Contacts c
	where a.Number=2 and c.FK_Person = (select id from People where LastName = 'Panzenbck');
